...
public class View {
	...
	public void insertButtons() {
		addButton(Strings.BUTTON_BUY, 1, 1).setOnMouseClicked( (MouseEvent event) -> {Controller.getInstance().buyButtonPressed();} );		
		addButton(Strings.BUTTON_GET, 0, 1).setOnMouseClicked((MouseEvent event) -> {Controller.getInstance().getButtonPressed();} );	
		addButton(Strings.BUTTON_PUT, 0, 2).setOnMouseClicked((MouseEvent event) -> {Controller.getInstance().putButtonPressed();} );	
		addButton(Strings.BUTTON_PACKAGE, 2, 1).setOnMouseClicked((MouseEvent event) -> {Controller.getInstance().toPackageButtonPressed();} );	
		addButton(Strings.BUTTON_CLEAR, 3, 1).setOnMouseClicked((MouseEvent event) -> {Controller.getInstance().clearButtonPressed();} );	
	}
